...
import freejava.com.remindme.adapter.TabsFragmentAdapter;
...
public class MainActivity extends AppCompatActivity{
    ...
    private  void showNotificationTab(){
        viewPager.setCurrentItem(Constatnts.TAB_TWO);
    ...
    private class RemindMeTask extends AsyncTask<Void, Void, RemindDTO>{
        ...
        protected RemindDTO doInBackground(Void... params) {
            ...
            return template.getForObject(Constatnts.URL.GET_REMIND_ITEM, RemindDTO.class);
        }
